...
void Ifs3D::Resources::Init(glm::uvec3 resolution) {
...
void Ifs3D::RenderIFS(Ifs3D::Resources& res) {
...
void Ifs3D::RenderRaymarchedIfs(Ifs3D::Resources& res, Texture2D& output_tex) {
